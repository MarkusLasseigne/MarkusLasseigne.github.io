...
var level1 = function(){
	...
	statObjs.push(coin1 = new refInit.draw("coin", 20, 20, x-100, y-100, "rgba(200,200,0,1)"));
	statObjs.push(coin2 = new refInit.draw("coin", 20, 20, x-150, y-100, "rgba(200,200,0,1)"));
