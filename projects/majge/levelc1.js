...
var level1 = function(){
	...
	statObjs.push(wallT1 = new refInit.draw("static", "", 54, 154, 720, y-154, "rgba(0,60,0,1)"));
	statObjs.push(wallT2 = new refInit.draw("static", "", 200, 30, 1420, y-10, "rgba(0,160,0,1)"));
	statObjs.push(wallT3 = new refInit.draw("static", "wall", 100, 30, 700, y-314, "rgba(46,24,0,1)"));
//	statObjs.push(wallT4 = new refInit.draw("static", "", 10, 40, 300, y-180, "rgba(0,0,0,1)"));
	statObjs.push(coin1 = new refInit.draw("coin", "coin", 30, 30, 150, y-152, "rgba(200,200,0,0.9)"));
	statObjs.push(coin2 = new refInit.draw("coin", "coin", 30, 30, 375, y-304, "rgba(200,200,0,0.9)"));
	statObjs.push(coin3 = new refInit.draw("coin", "coin", 30, 30, 1320, y-314, "rgba(200,200,0,0.9)"));
	player1 = new refInit.draw("player", "player", 40, 120, 20, y+100, "rgba(50,20,0,1)");
	player1.gravity=1;
	statObjs.push(scoreTxt = new refInit.draw("sText", "score", 60, 20, 10, y+10, "rgba(0,0,0,1)", null, "Score: "+player1.score, " Ariel"));
};