...
function updateGame1(){
	refInit.clear();
	movement(player1, "sLB", "sRB", "wasd", "arrows","space");
	skyBack.update();
...
var level1 = function(){
	...
	statObjs.push(wallT2 = new refInit.draw("static", 200, 10, x-400, y-10, "rgba(0,160,0,1)"));
...
//	statObjs.push(wallT4 = new refInit.draw("static", 10, 40, 300, y-180, "rgba(0,0,0,1)"));
	...
	statObjs.push(coin3 = new refInit.draw("coin", 30, 30, x-500, y-314, "rgba(200,200,0,0.9)"));
